...
void ControlTreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ControlTreeWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ControlTreeWidget::*)(WidgetTabType );
...
QT_INIT_METAOBJECT const QMetaObject ControlTreeWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ControlTreeWidget.data,
    qt_meta_data_ControlTreeWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
