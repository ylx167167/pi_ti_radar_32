...
SplashScreen *SplashScreen::getInstance()
{
    ...
    {
//        m_instance = new SplashScreen(QPixmap(":/res/res/image/other/splash2.jpg"));
        m_instance = new SplashScreen(QPixmap(":/res/res/image/other/splash3.png"));
...
//        painterPathPath.addRect(rect, BORDER_X_RADIUS, BORDER_X_RADIUS);
