...
//    m_BgColor = QColor(160,160,160);
    m_BgColor = QColor(0,170,255);
    m_FrontColor = Qt::darkRed;
...
//    haloGradient.setColorAt(1, QColor(160,160,160)); //灰
    haloGradient.setColorAt(1, QColor(0,170,255)); //灰
    ...
    coneGradient.setColorAt(0.0, Qt::blue);
    coneGradient.setColorAt(0.2, niceBlue);
    coneGradient.setColorAt(0.5, Qt::white);
    coneGradient.setColorAt(1.0, Qt::blue);
    painter->save();
    painter->translate(hlafWidth,hlafWidth);
...
void CCtrlDashBoard::paintEvent(QPaintEvent * event)
{
    ...
    printf("wayne   %d   %d",(this->width()),this->height());
